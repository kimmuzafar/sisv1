...
namespace Wit\DHBundle\Controller;
...
class DefaultController extends Controller
{
    ...
    public function indexAction()
    {
    	...
    	//TODO: isForSad should be isForDH, please check

        $em = $this->getDoctrine()->getManager();
        $sadLogs = $em->getRepository('ModelBundle:UserLogs')->findBy(array('isForDh' => 1), array('id'=>'DESC'), 10);
        if (!$sadLogs) {
