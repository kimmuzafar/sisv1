...
use Wit\SettingBundle\Form\CourseType;
...
class CourseController extends Controller
{
    ...
    private function createCreateForm(Course $entity)
    {
        $form = $this->createForm(new CourseType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_course_new'),
            'method' => 'POST',
            'attr' => array(
                'id'    => 'add-new-form',
            )
    ...
    public function newAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')){
            ...
            if ($addform->isValid()) {
                ...
                return $this->redirect($this->generateUrl('wit_setting_course_index'));
            }
    ...
    {
        $form = $this->createForm(new CourseType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_course_update', array('id' => $entity->getId())),
            'method' => 'PUT',
            'attr' => array(
