...
use Wit\SettingBundle\Form\CoursequarterType;

/**
 * Coursequarter controller.
 *
 * @Route("/course-quarter")
 */
class CoursequarterController extends Controller
{
    /**
    ...
    {
        $form = $this->createForm(new CoursequarterType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_coursequarter_new'),
            'method' => 'POST',
            'attr' => array(
                'id'    => 'add-new-form',
            )
    ...
    public function newAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')){
            ...
            if ($addform->isValid()) {
                ...
                return $this->redirect($this->generateUrl('wit_setting_coursequarter_index'));
            }
    ...
    {
        $form = $this->createForm(new CoursequarterType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_coursequarter_update', array('id' => $entity->getId())),
            'method' => 'PUT',
            'attr' => array(
