...
use Wit\SettingBundle\Form\CoursecategoryType;
...
class CoursecategoryController extends Controller
{
    ...
    {
        $form = $this->createForm(new CoursecategoryType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_coursecategory_new'),
            'method' => 'POST',
            'attr' => array(
                'id'    => 'add-new-form',
            )
    ...
    public function newAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')){
            ...
            if ($addform->isValid()) {
                ...
                return $this->redirect($this->generateUrl('wit_setting_coursecategory_index'));
            }
    ...
    {
        $form = $this->createForm(new CoursecategoryType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_coursecategory_update', array('id' => $entity->getId())),
            'method' => 'PUT',
            'attr' => array(
