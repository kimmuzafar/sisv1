...
use Wit\ModelBundle\Entity\Country;
use Wit\SettingBundle\Form\CountryType;
...
class CountryController extends Controller
{
    ...
    public function indexAction($id=null)
    {
        ...
        $entities = $em->getRepository('ModelBundle:Country')->findBy(array(), array('id' => 'DESC'));

        //form to create
        $addform = $this->createCreateForm(new Country());

        //if user wants to edit a record
        if($id){
            $editEntity = $em->getRepository('ModelBundle:Country')->find($id);
            if (!$editEntity) {
    ...
    private function createCreateForm(Country $entity)
    {
        $form = $this->createForm(new CountryType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_country_new'),
            'method' => 'POST',
            'attr' => array(
                'id'    => 'add-new-form',
            )
    ...
    public function newAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')){
            ...
            if ($addform->isValid()) {
                ...
                return $this->redirect($this->generateUrl('wit_setting_country_index'));
            }
    ...
    {
        $form = $this->createForm(new CountryType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_country_update', array('id' => $entity->getId())),
            'method' => 'PUT',
            'attr' => array(
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $entity = $em->getRepository('ModelBundle:Country')->find($id);
