...
use Wit\ModelBundle\Entity\City;
use Wit\SettingBundle\Form\CityType;
...
class CityController extends Controller
{
    ...
    public function indexAction($id=null)
    {
        ...
        $entities = $em->getRepository('ModelBundle:City')->findBy(array(), array('id' => 'DESC'));

        //form to create
        $addform = $this->createCreateForm(new City());

        //if user wants to edit a record
        if($id){
            $editEntity = $em->getRepository('ModelBundle:City')->find($id);
            if (!$editEntity) {
    ...
    private function createCreateForm(City $entity)
    {
        $form = $this->createForm(new CityType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_city_new'),
            'method' => 'POST',
            'attr' => array(
                'id'    => 'add-new-form',
            )
    ...
    public function newAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')){
            ...
            if ($addform->isValid()) {
                ...
                return $this->redirect($this->generateUrl('wit_setting_city_index'));
            }
    ...
    {
        $form = $this->createForm(new CityType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_city_update', array('id' => $entity->getId())),
            'method' => 'PUT',
            'attr' => array(
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $entity = $em->getRepository('ModelBundle:City')->find($id);
