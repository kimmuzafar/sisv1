...
use Wit\ModelBundle\Entity\Grade;
use Wit\SettingBundle\Form\GradeType;
...
class GradeController extends Controller
{
    ...
    public function indexAction($id=null)
    {
        ...
        $entities = $em->getRepository('ModelBundle:Grade')->findBy(array(), array('id' => 'DESC'));

        //form to create
        $addform = $this->createCreateForm(new Grade());

        //if user wants to edit a record
        if($id){
            $editEntity = $em->getRepository('ModelBundle:Grade')->find($id);
            if (!$editEntity) {
    ...
    private function createCreateForm(Grade $entity)
    {
        $form = $this->createForm(new GradeType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_grade_new'),
            'method' => 'POST',
            'attr' => array(
                'id'    => 'add-new-form',
            )
    ...
    public function newAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')){
            ...
            if ($addform->isValid()) {
                ...
                return $this->redirect($this->generateUrl('wit_setting_grade_index'));
            }
    ...
    {
        $form = $this->createForm(new GradeType(), $entity, array(
            'action' => $this->generateUrl('wit_setting_grade_update', array('id' => $entity->getId())),
            'method' => 'PUT',
            'attr' => array(
                'id' => 'update-form',
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $entity = $em->getRepository('ModelBundle:Grade')->find($id);
