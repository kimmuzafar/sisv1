...
class CourseType extends AbstractType
{
    ...
    {
        $builder
            ->add('coursequarter', 'entity', array('label'=>'Quarter', 'class'=>'ModelBundle:CourseQuarter', 'empty_value'=>'- Select Quarter..', 'property'=>'title', 'multiple'=>false, 'attr'=>array('class'=>'gui-input', 'placeholder'=>'Quarter..')))
