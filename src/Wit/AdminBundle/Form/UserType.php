...
class UserType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('roles',      'entity',   array('label'=>'Role', 'class'=>'ModelBundle:Role', 'empty_value'=>'- Select Role..', 'property'=>'role', 'multiple'=>true, 'attr'=>array()))

            ->add('mobile', 'text', array('label'=>'Mobile', 'attr'=>array('class'=>'gui-input', 'placeholder'=>'Mobile e-g: 966533432212')))
